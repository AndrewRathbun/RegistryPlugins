...
namespace RegistryPlugin.SAM
{
    public class UserOut:IValueOut
    {
        ...
        public string BatchValueData2 => $"Created: {CreatedOn.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff} Last login: {LastLoginTime?.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff} Last incorrect password: {LastIncorrectPassword?.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff} Last password change: {LastPasswordChange?.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff}";
